...
/*
* 添加一个pass 需要修改EMeshPass，以及下面那个Switch后面的那个常量
* 以及FPSOCollectorCreateManager::MaxPSOCollectorCount的这个常量
*/
...
inline const TCHAR* GetMeshPassName(EMeshPass::Type MeshPass)
{
	...
	case EMeshPass::WaterBallPass:return TEXT("WaterBallPass");
#if WITH_EDITOR
