...
int32 FHLSLMaterialTranslator::SMinShaderToy(int32 A, int32 B, int32 K)
{
	if (A == INDEX_NONE || B == INDEX_NONE || K == INDEX_NONE)
		return INDEX_NONE;
	
	return AddCodeChunk(MCT_Float, TEXT("SMinShaderToy(%s,%s,%s)"), *CoerceParameter(A, MCT_Float), *CoerceParameter(B, MCT_Float), *CoerceParameter(K, MCT_Float));
	//return INDEX_NONE;
}
